...
from chess_recognition.utils import ChessboardNotLocatedException, to_homogenous_coordinates, from_homogenous_coordinates
...
if __name__ == "__main__":
    ...
    parser.add_argument("file", type=str, help="Path of the input image file")
    ...
    #filename = Path('data/train/0151.png')
